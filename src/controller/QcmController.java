...
public class QcmController {
	...
	@Autowired         
	QcmMetier services;    // services est un interface: spring, grace Ã  @Autowired, lui associe une instanciation des l'objet qcmService dÃ©finit dans spring-beans.xml
	Qcm qcm = new Qcm();
	...
	public String initialiserQcm(Model model, Qcm qcm, Questionnaire questionnaire, String[] choix, Integer[] bnrs,
	    ...
	    DateTime dt = new DateTime();
		 /* Conversion de la date en String selon le format dÃ©fini */
