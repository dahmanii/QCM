...
public class QcmController {
	...
	public String vueInternauteClassement(Model model){
		...
		for(Internaute inter: liste) 
			if(inter.getId() == this.user.getId()) inter.setNom("#AFE6B1"); // on stock la couleur vers ou rien dans la propri�t� nom inutilis� dans la vue
			else inter.setNom("");
	...
	public String listeQcmByCategorie(Model model , @RequestParam(value="categorie") String categorie){
		...
		System.out.println("categorie recupéréé: "+categorie);
